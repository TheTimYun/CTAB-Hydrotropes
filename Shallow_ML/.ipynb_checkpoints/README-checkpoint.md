...
**Base classifiers** folder contains files, that describe the development of models, trained on system properties only and molecular descriptors only. Results are used as supplement to reveal the role of both types of descriptors. 